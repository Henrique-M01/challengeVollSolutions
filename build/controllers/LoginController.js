...
function createLogin(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, name_1, email, password, createUser, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    _a = req.body, name_1 = _a.name, email = _a.email, password = _a.password;
                    return [4 /*yield*/, LoginService_1.default.createLogin(name_1, email, password)];
                case 1:
                    createUser = _b.sent();
                    if (!createUser)
                        return [2 /*return*/, res.status(400).json({ message: 'User already exists' })];
                    return [2 /*return*/, res.status(201).json(createUser)];
                case 2:
                    error_1 = _b.sent();
                    next(error_1);
                    return [3 /*break*/, 3];
